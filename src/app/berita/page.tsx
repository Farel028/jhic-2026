    ...
    <main id="konten-utama" className="flex-1">
      ...
      <section className="hero-grid border-b border-ink/10 px-5 py-14 sm:px-8 sm:py-20 lg:px-10 lg:py-24">
        <div className="mx-auto w-full max-w-site">
          <nav aria-label="Breadcrumb"><ol className="flex flex-wrap items-center gap-2 text-xs font-bold uppercase tracking-[0.12em] text-ink-muted"><li><Link href="/" className="hover:text-primary">Beranda</Link></li><li aria-hidden="true">/</li><li><Link href="/dokumentasi" className="hover:text-primary">Dokumentasi</Link></li><li aria-hidden="true">/</li><li aria-current="page" className="text-ink-strong">Berita</li></ol></nav>
          <div className="mt-12 grid items-end gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:gap-20">
            <div><p className="eyebrow">Newsroom sekolah</p><h1 className="mt-5 max-w-5xl text-[clamp(3.8rem,8vw,8rem)] font-black leading-[0.84] tracking-[-0.075em] text-ink-strong">Kabar, karya, <span className="block text-primary">dan langkah baru.</span></h1></div>
