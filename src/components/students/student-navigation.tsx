...
import { studentNavigation } from "@/data/students";

type StudentNavigationProps = {
  activeHref: (typeof studentNavigation)[number]["href"];
};

export function StudentNavigation({ activeHref }: StudentNavigationProps) {
  return (
