...
type AboutNavigationProps = {
  activeHref: (typeof aboutNavigation)[number]["href"];
};

export function AboutNavigation({ activeHref }: AboutNavigationProps) {
  return (
    <nav aria-label="Navigasi Tentang Sekolah" className="border-b border-ink/10 bg-white">
